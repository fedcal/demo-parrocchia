...
hero:
  name: "Demo Parrocchia"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://parrocchia.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-parrocchia
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Parrocchia.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Parrocchia** in Italia.
...
Il mercato italiano delle PMI per **Parrocchia** ha caratteristiche specifiche:
...
```bash
git clone https://github.com/fedcal/federico-demo-parrocchia.git
cd federico-demo-parrocchia
npm install
npm start
# → http://localhost:4200
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-parrocchia)
