...
URL: `https://parrocchia.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `parrocchia.demo.federicocalo.dev`
...
- Output directory: `dist/parrocchia/browser`
...
URL: `https://fedcal.github.io/federico-demo-parrocchia/`
...
- `base: /federico-demo-parrocchia/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `parrocchia-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   parrocchia-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `parrocchia-docs.federicocalo.dev`
